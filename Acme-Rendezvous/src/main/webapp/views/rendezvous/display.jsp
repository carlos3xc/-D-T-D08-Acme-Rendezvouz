...
<%@taglib prefix="display" uri="http://displaytag.sf.net"%>
	...
	<b><spring:message code="rendezvous.creator" /></b>: <jstl:out value="${rendezvous.user}"></jstl:out><br/>
...
<h3>	<spring:message code="rendezvous.linkedRendezvous" /></h3><br/>	
	
	<!--  Lista de citas similares a la actual -->	
		<display:table name="linkedRendezvous" id="row" requestURI="rendezvous/linkedRendezvous/list.do" pagesize="5">
	...
	<display:table name="announcements" id="row" requestURI="rendezvous/announcement/list.do" pagesize="5">
	...
	<display:table name="comments" id="row" requestURI="rendezvous/comment/list.do" pagesize="5">
		...
		<display:column>
			<b><jstl:out value="${row.user}"/></b> - <jstl:out value="${row.moment}"/><br/>
